...
\includegraphics[scale=0.3]{../common/platecarre_thumb.png}  }
\subfigure[Mercator]{
\includegraphics[scale=0.3]{../common/mercator_thumb.png}  }

\subfigure[Gall-Peters]{
\includegraphics[scale=0.3]{../common/gallpeters_thumb.png} }
\subfigure[Azimuthal Equidistant]{
\includegraphics[scale=0.3]{../common/aziequi_thumb.png} }

\subfigure[Gnomonic]{
\includegraphics[scale=0.3]{../common/gnomo_thumb.png} }
\subfigure[Mollweide]{
\includegraphics[scale=0.3]{../common/mollweide_thumb.png} }
